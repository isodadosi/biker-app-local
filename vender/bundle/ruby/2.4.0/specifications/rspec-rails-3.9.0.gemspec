# -*- encoding: utf-8 -*-
# stub: rspec-rails 3.9.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2019-10-08"
  s.description = "rspec-rails is a testing framework for Rails 3+.".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.9.0"])
      s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.9.0"])
      s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.9.0"])
      s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.9.0"])
      s.add_development_dependency(%q<cucumber>.freeze, ["~> 1.3.5"])
      s.add_development_dependency(%q<aruba>.freeze, ["~> 0.5.4"])
      ...
      s.add_dependency(%q<rspec-core>.freeze, ["~> 3.9.0"])
      s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.9.0"])
      s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.9.0"])
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.9.0"])
      s.add_dependency(%q<cucumber>.freeze, ["~> 1.3.5"])
      s.add_dependency(%q<aruba>.freeze, ["~> 0.5.4"])
