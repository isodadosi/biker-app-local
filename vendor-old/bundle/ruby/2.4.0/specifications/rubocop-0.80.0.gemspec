...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<unicode-display_width>.freeze, ["< 1.7", ">= 1.4.0"])
      s.add_development_dependency(%q<bundler>.freeze, ["< 3.0", ">= 1.15.0"])
    else
      ...
      s.add_dependency(%q<unicode-display_width>.freeze, ["< 1.7", ">= 1.4.0"])
      s.add_dependency(%q<bundler>.freeze, ["< 3.0", ">= 1.15.0"])
    end
  else
    s.add_dependency(%q<jaro_winkler>.freeze, ["~> 1.5.1"])
    s.add_dependency(%q<parallel>.freeze, ["~> 1.10"])
