# -*- encoding: utf-8 -*-
# stub: rspec-core 3.9.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-core-3.9.1".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.9.1"])
      ...
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.9.1"])
