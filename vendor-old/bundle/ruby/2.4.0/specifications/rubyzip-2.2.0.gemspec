...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubyzip/rubyzip/issues", "changelog_uri" => "https://github.com/rubyzip/rubyzip/blob/v2.2.0/Changelog.md", "documentation_uri" => "https://www.rubydoc.info/gems/rubyzip/2.2.0", "source_code_uri" => "https://github.com/rubyzip/rubyzip/tree/v2.2.0", "wiki_uri" => "https://github.com/rubyzip/rubyzip/wiki" } if s.respond_to? :metadata=
