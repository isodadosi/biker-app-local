...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rake>.freeze, ["< 14.0", ">= 10.4"])
      s.add_runtime_dependency(%q<activerecord>.freeze, ["< 7.0", ">= 3.2"])
    else
      s.add_dependency(%q<rake>.freeze, ["< 14.0", ">= 10.4"])
      s.add_dependency(%q<activerecord>.freeze, ["< 7.0", ">= 3.2"])
    end
  else
    s.add_dependency(%q<rake>.freeze, ["< 14.0", ">= 10.4"])
    s.add_dependency(%q<activerecord>.freeze, ["< 7.0", ">= 3.2"])
