# -*- encoding: utf-8 -*-
# stub: solargraph 0.38.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<maruku>.freeze, [">= 0.7.3", "~> 0.7"])
      s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.9.1", "~> 1.9"])
      s.add_runtime_dependency(%q<parser>.freeze, ["~> 2.3"])
      s.add_runtime_dependency(%q<reverse_markdown>.freeze, [">= 1.0.5", "~> 1.0"])
      ...
      s.add_dependency(%q<maruku>.freeze, [">= 0.7.3", "~> 0.7"])
      s.add_dependency(%q<nokogiri>.freeze, [">= 1.9.1", "~> 1.9"])
      s.add_dependency(%q<parser>.freeze, ["~> 2.3"])
      s.add_dependency(%q<reverse_markdown>.freeze, [">= 1.0.5", "~> 1.0"])
